...
-- 002_complaints.sql
-- Purpose: complaint/admin dashboard v2 functions, staff seed rows, complaint dashboard RLS,
-- complaint admin update RPC, and reporting/dashboard support.
-- Source consolidated from: supabase/admin-dashboard-v2.sql

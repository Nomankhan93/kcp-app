...
-- Purpose: initial base schema for portal roles, complaint categories, areas, staff, complaints,
-- complaint attachments/history, storage buckets, public submit/track RPCs, and base RLS.
-- Source consolidated from: supabase/schema.sql

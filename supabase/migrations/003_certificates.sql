...
-- Purpose: birth/marriage/death certificate application tables, documents/history,
-- public apply/track RPCs, admin certificate operations, storage bucket policies,
-- and final certificate processing/upload workflow.
-- Sources consolidated from:
--   - supabase/certificates-v1.sql
--   - supabase/certificate-final-processing-v2.sql
-- Run after: 002_complaints.sql

...
-- 005_cms.sql
-- Purpose: public CMS tables and RPCs for notices, news, downloads/forms,
-- leadership messages, and CMS storage support.
-- Source consolidated from: supabase/public-cms-v1.sql
-- Run after: 004_councilor_verification.sql
